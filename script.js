...
$(document).ready(function () {
   ...
   $('select').click(function(){
       ...
       if(option === 'vm'){
            $('#sampleimg').attr('src','/sess/devlab1/images/vending_machine_screenshot.PNG');
            ...
            $('#tryout').attr('href','/sess/devlab1/vm/vending_machine.html');
       }else if(option === "hh"){
            $('#sampleimg').attr('src','/sess/devlab1/images/hats_hoods_screenshot.PNG');
            $('#description').text('(Incomplete) A website for a fictitious company. I am making this purely for practice.');
            $('#tryout').attr('href','/sess/devlab1/h&h/h&h.html');
       }
   });
});